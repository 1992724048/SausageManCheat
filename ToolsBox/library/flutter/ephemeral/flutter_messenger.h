...
extern "C" {
    ...
    using FlutterDesktopMessengerRef = struct FlutterDesktopMessenger*;

    // Opaque handle for tracking responses to messages.
    using FlutterDesktopMessageResponseHandle = struct _FlutterPlatformMessageResponseHandle;

    // The callback expected as a response of a binary message.
    using FlutterDesktopBinaryReply = void(*)(const uint8_t* data, size_t data_size, void* user_data);

    // A message received from Flutter.
    using FlutterDesktopMessage = struct {
    ...
    using FlutterDesktopMessageCallback = void(*)(FlutterDesktopMessengerRef /* messenger */, const FlutterDesktopMessage* /* message*/, void* /* user data */);

    // Sends a binary message to the Flutter side on the specified channel.
    FLUTTER_EXPORT auto FlutterDesktopMessengerSend(FlutterDesktopMessengerRef messenger, const char* channel, const uint8_t* message, size_t message_size) -> bool;

    // Sends a binary message to the Flutter side on the specified channel.
    // The |reply| callback will be executed when a response is received.
    FLUTTER_EXPORT auto FlutterDesktopMessengerSendWithReply(FlutterDesktopMessengerRef messenger,
                                                             const char* channel,
                                                             const uint8_t* message,
                                                             size_t message_size,
    ...
    FLUTTER_EXPORT auto FlutterDesktopMessengerSendResponse(FlutterDesktopMessengerRef messenger, const FlutterDesktopMessageResponseHandle* handle, const uint8_t* data, size_t data_length) -> void;
    ...
    FLUTTER_EXPORT auto FlutterDesktopMessengerSetCallback(FlutterDesktopMessengerRef messenger, const char* channel, FlutterDesktopMessageCallback callback, void* user_data) -> void;
    ...
    FLUTTER_EXPORT auto FlutterDesktopMessengerAddRef(FlutterDesktopMessengerRef messenger) -> FlutterDesktopMessengerRef;
    ...
    FLUTTER_EXPORT auto FlutterDesktopMessengerRelease(FlutterDesktopMessengerRef messenger) -> void;
    ...
    FLUTTER_EXPORT auto FlutterDesktopMessengerIsAvailable(FlutterDesktopMessengerRef messenger) -> bool;
    ...
    FLUTTER_EXPORT auto FlutterDesktopMessengerLock(FlutterDesktopMessengerRef messenger) -> FlutterDesktopMessengerRef;
    ...
    FLUTTER_EXPORT auto FlutterDesktopMessengerUnlock(FlutterDesktopMessengerRef messenger) -> void;
