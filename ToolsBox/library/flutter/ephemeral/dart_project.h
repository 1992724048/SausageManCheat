...
namespace flutter {
    ...
    public:
        ...
        explicit DartProject(const std::wstring& assets_path, const std::wstring& icu_data_path, const std::wstring& aot_library_path) {
        ...
        auto set_dart_entrypoint(const std::string& entrypoint) -> void {
            if (entrypoint.empty()) {
                return;
            }
    ...
    private:
        ...
        auto assets_path() const -> const std::wstring& {
            return assets_path_;
        }

        auto icu_data_path() const -> const std::wstring& {
            return icu_data_path_;
        }

        auto aot_library_path() const -> const std::wstring& {
        ...
        GpuPreference gpu_preference_ = GpuPreference::LowPowerPreference;
