...
namespace flutter {
    ...
    public:
        ...
        auto operator=(const PluginRegistrar&) -> PluginRegistrar& = delete;
        ...
        auto AddPlugin(std::unique_ptr<Plugin> plugin) -> void;

    protected:
        auto registrar() const -> FlutterDesktopPluginRegistrarRef {
            return registrar_;
        }
    ...
    public:
        static auto GetInstance() -> PluginRegistrarManager*;

        // Prevent copying.
        PluginRegistrarManager(const PluginRegistrarManager&) = delete;
        auto operator=(const PluginRegistrarManager&) -> PluginRegistrarManager& = delete;
        ...
        template<class T>
        auto GetRegistrar(FlutterDesktopPluginRegistrarRef registrar_ref) -> T* {
            auto insert_result = registrars_.emplace(registrar_ref, std::make_unique<T>(registrar_ref));
    ...
    private:
        ...
        static auto OnRegistrarDestroyed(FlutterDesktopPluginRegistrarRef registrar) -> void;

        auto registrars() -> WrapperMap* {
            return &registrars_;
        }
