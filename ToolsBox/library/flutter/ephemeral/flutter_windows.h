...
extern "C" {
    ...
    using VoidCallback = void(*)(void* /* user data */);

    // Opaque reference to a Flutter view controller.
    struct FlutterDesktopViewController;
    using FlutterDesktopViewControllerRef = struct FlutterDesktopViewController*;

    // Opaque reference to a Flutter window.
    struct FlutterDesktopView;
    using FlutterDesktopViewRef = struct FlutterDesktopView*;

    // Opaque reference to a Flutter engine instance.
    struct FlutterDesktopEngine;
    using FlutterDesktopEngineRef = struct FlutterDesktopEngine*;

    // The unique identifier for a view.
    using FlutterDesktopViewId = int64_t;

    // Configures how the Flutter engine selects a GPU.
    using FlutterDesktopGpuPreference = enum {
        // No preference.
        NoPreference,
    ...
    using FlutterDesktopUIThreadPolicy = enum {
    ...
    using FlutterDesktopEngineProperties = struct {
    ...
    FLUTTER_EXPORT auto FlutterDesktopViewControllerCreate(int width, int height, FlutterDesktopEngineRef engine) -> FlutterDesktopViewControllerRef;

    // Shuts down the engine instance associated with |controller|, and cleans up
    // associated state.
    //
    // |controller| is no longer valid after this call.
    FLUTTER_EXPORT auto FlutterDesktopViewControllerDestroy(FlutterDesktopViewControllerRef controller) -> void;

    // Returns the view controller's view ID.
    FLUTTER_EXPORT auto FlutterDesktopViewControllerGetViewId(FlutterDesktopViewControllerRef view_controller) -> FlutterDesktopViewId;

    // Returns the handle for the engine running in FlutterDesktopViewControllerRef.
    //
    // Its lifetime is the same as the |controller|'s.
    FLUTTER_EXPORT auto FlutterDesktopViewControllerGetEngine(FlutterDesktopViewControllerRef controller) -> FlutterDesktopEngineRef;

    // Returns the view managed by the given controller.
    FLUTTER_EXPORT auto FlutterDesktopViewControllerGetView(FlutterDesktopViewControllerRef controller) -> FlutterDesktopViewRef;

    // Requests new frame from the engine and repaints the view.
    FLUTTER_EXPORT auto FlutterDesktopViewControllerForceRedraw(FlutterDesktopViewControllerRef controller) -> void;
    ...
    FLUTTER_EXPORT auto FlutterDesktopViewControllerHandleTopLevelWindowProc(FlutterDesktopViewControllerRef controller,
                                                                             HWND hwnd,
                                                                             UINT message,
                                                                             WPARAM wparam,
                                                                             LPARAM lparam,
    ...
    FLUTTER_EXPORT auto FlutterDesktopEngineCreate(const FlutterDesktopEngineProperties* engine_properties) -> FlutterDesktopEngineRef;
    ...
    FLUTTER_EXPORT auto FlutterDesktopEngineDestroy(FlutterDesktopEngineRef engine) -> bool;
    ...
    FLUTTER_EXPORT auto FlutterDesktopEngineRun(FlutterDesktopEngineRef engine, const char* entry_point) -> bool;
    ...
    FLUTTER_EXPORT auto FlutterDesktopEngineProcessMessages(FlutterDesktopEngineRef engine) -> uint64_t;

    FLUTTER_EXPORT auto FlutterDesktopEngineReloadSystemFonts(FlutterDesktopEngineRef engine) -> void;

    // Returns the plugin registrar handle for the plugin with the given name.
    //
    // The name must be unique across the application.
    FLUTTER_EXPORT auto FlutterDesktopEngineGetPluginRegistrar(FlutterDesktopEngineRef engine, const char* plugin_name) -> FlutterDesktopPluginRegistrarRef;
    ...
    FLUTTER_EXPORT auto FlutterDesktopEngineGetMessenger(FlutterDesktopEngineRef engine) -> FlutterDesktopMessengerRef;

    // Returns the texture registrar associated with the engine.
    FLUTTER_EXPORT auto FlutterDesktopEngineGetTextureRegistrar(FlutterDesktopEngineRef engine) -> FlutterDesktopTextureRegistrarRef;
    ...
    FLUTTER_EXPORT auto FlutterDesktopEngineSetNextFrameCallback(FlutterDesktopEngineRef engine, VoidCallback callback, void* user_data) -> void;

    // ========== View ==========

    // Returns the backing HWND for manipulation in host application.
    FLUTTER_EXPORT auto FlutterDesktopViewGetHWND(FlutterDesktopViewRef view) -> HWND;

    // Returns the DXGI adapter used for rendering or nullptr in case of error.
    FLUTTER_EXPORT auto FlutterDesktopViewGetGraphicsAdapter(FlutterDesktopViewRef view) -> IDXGIAdapter*;
    ...
    FLUTTER_EXPORT auto FlutterDesktopEngineProcessExternalWindowMessage(FlutterDesktopEngineRef engine, HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam, LRESULT* result) -> bool;
    ...
    using FlutterDesktopWindowProcCallback = bool(*)(HWND /* hwnd */, UINT /* uMsg */, WPARAM /*wParam*/, LPARAM /* lParam*/, void* /* user data */, LRESULT* result);
    ...
    FLUTTER_EXPORT auto FlutterDesktopPluginRegistrarGetView(FlutterDesktopPluginRegistrarRef registrar) -> FlutterDesktopViewRef;

    // Returns the view associated with the registrar's engine instance, or null if
    // the view does not exist.
    FLUTTER_EXPORT auto FlutterDesktopPluginRegistrarGetViewById(FlutterDesktopPluginRegistrarRef registrar, FlutterDesktopViewId view_id) -> FlutterDesktopViewRef;

    FLUTTER_EXPORT auto FlutterDesktopPluginRegistrarRegisterTopLevelWindowProcDelegate(FlutterDesktopPluginRegistrarRef registrar, FlutterDesktopWindowProcCallback delegate, void* user_data) -> void;

    FLUTTER_EXPORT auto FlutterDesktopPluginRegistrarUnregisterTopLevelWindowProcDelegate(FlutterDesktopPluginRegistrarRef registrar, FlutterDesktopWindowProcCallback delegate) -> void;
    ...
    FLUTTER_EXPORT auto FlutterDesktopGetDpiForHWND(HWND hwnd) -> UINT;
    ...
    FLUTTER_EXPORT auto FlutterDesktopGetDpiForMonitor(HMONITOR monitor) -> UINT;
    ...
    FLUTTER_EXPORT auto FlutterDesktopResyncOutputStreams() -> void;
